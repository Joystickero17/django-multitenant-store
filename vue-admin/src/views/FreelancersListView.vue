        ...
        <div class="row mx-5 mb-4 ">
            <b-modal ref="filter-modal" hide-footer title="Filtros">
                <b-form-group label="Estados">
                    <b-form-checkbox-group v-model="states">
                ...
                <b-form-group label="Calificaciones">
                    <b-form-checkbox-group v-model="feedback">
            ...
            <div class="col-lg-4">
                <b-card class="h-100">
                    <b-card-text class="d-flex flex-column align-items-center justify-content-center">
                        ...
                        <h1 class="display-3">
                            <number ref="assistance_number" :from="0" :to="received_assistances"></number>
                        </h1>
        ...
        <div class="row mx-5 mb-4 p-3 border rounded">
            ...
            <div class="col-5 d-flex flex-row justify-content-center align-items-center">
                <div class="filters">
                    ...
                    <div @click="$refs['filter-modal'].show()"
                        class="order-filter mx-3 d-flex align-items-center justify-content-center pointer">
                ...
                <div class="w-50">
                    ...
                    <b-button variant="dark" @click="exportData">Exportar Asistencias</b-button>
                </div>
            </div>
        </div>
        <div class="row mx-5 mb-4 p-4 border rounded">
            ...
            <b-table striped hover :items="items" :fields="fields">
                ...
                <template #cell(completed)="data">
                    <span
                        :class="{ 'text-success font-weight-bold': !!data.item.completed, 'text-danger font-weight-bold': !data.item.completed }">
...
export default {
    ...
    methods: {
        exportData(){
            this.$axios("api/assistance_export/", { params: { search: this.search, states: this.states, feedback: this.feedback } })
                .then(() => {})
                .catch((err) => {
