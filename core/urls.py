...
router.register(r"export_files", views.ExportFileView) # reportes exportados
...
router.register(r"assistance_export", views.FreelanceAssistanceExport)
...
router.register(r"order_export", views.OrderViewSetExport)
router.register(r"cart", views.CartItemViewSet)
router.register(r"contact_export", views.ContactViewSetExport)
...
router.register(r"store_product_export", views.PrivateStoreProductExport)
...
urlpatterns = [
    ...
    path('chart_export/', views.HistoricSalesViewExport.as_view()),
